program convolve ! Convolution synthetic spectra from synthV by rotation,macroturbulence and Gassian profile
 ...
 read(1,*)Vmacro        ! Macroturbulent velocity
 read(1,*,iostat=ios)Resolved_power ! Resolution
 if(ios /= 0)Resolved_power=-1
 read(1,'((a))')file_name 
 open(11,file=file_name )

 read(10,rec=1)wavelength_first,wavelength_last,wavelength_step,number_of_wavelengths,Teff,glog,V_micro 
...
! Convolution with rotation & macroturbulence
   ...
   do i=1,number_of_wavelengths
    ...
    read(10,rec=i+1)flux_c(i),flux(i),Inu_c,Inu_l,effective_depth_tau,effective_depth_number
