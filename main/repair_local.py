...
synthV_core1 = synthetic(wd_synthv="synthV_Imu_core1/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core1 = synthetic(wd_synthv="synthV_Imu_core1/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core2 = synthetic(wd_synthv="synthV_Imu_core2/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core2 = synthetic(wd_synthv="synthV_Imu_core2/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core3 = synthetic(wd_synthv="synthV_Imu_core3/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core3 = synthetic(wd_synthv="synthV_Imu_core3/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core4 = synthetic(wd_synthv="synthV_Imu_core4/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core4 = synthetic(wd_synthv="synthV_Imu_core4/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core5 = synthetic(wd_synthv="synthV_Imu_core5/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core5 = synthetic(wd_synthv="synthV_Imu_core5/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core6 = synthetic(wd_synthv="synthV_Imu_core6/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core6 = synthetic(wd_synthv="synthV_Imu_core6/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core7 = synthetic(wd_synthv="synthV_Imu_core7/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core7 = synthetic(wd_synthv="synthV_Imu_core7/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core8 = synthetic(wd_synthv="synthV_Imu_core8/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core8 = synthetic(wd_synthv="synthV_Imu_core8/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())


synthV_core9 = synthetic(wd_synthv="synthV_Imu_core9/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                         if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core9 = synthetic(wd_synthv="synthV_Imu_core9/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                             if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core10 = synthetic(wd_synthv="synthV_Imu_core10/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                          if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core10 = synthetic(wd_synthv="synthV_Imu_core10/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                              if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core11 = synthetic(wd_synthv="synthV_Imu_core11/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                          if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core11 = synthetic(wd_synthv="synthV_Imu_core11/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                              if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core12 = synthetic(wd_synthv="synthV_Imu_core12/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                          if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core12 = synthetic(wd_synthv="synthV_Imu_core12/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                              if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())


synthV_core13 = synthetic(wd_synthv="synthV_Imu_core13/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                          if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core13 = synthetic(wd_synthv="synthV_Imu_core13/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                              if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())

synthV_core14 = synthetic(wd_synthv="synthV_Imu_core14/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                          if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core14 = synthetic(wd_synthv="synthV_Imu_core14/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                              if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())



synthV_core15 = synthetic(wd_synthv="synthV_Imu_core15/", db_atmos_models=mainconfig["atmmodels"], if_pyastr=True,
                          if_convolve=False, if_imu=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"], pref=os.getcwd())
synthV_imu_core15 = synthetic(wd_synthv="synthV_Imu_core15/", db_atmos_models=mainconfig["atmmodels"], if_convolve=False,
                              if_imu=True, if_lines=False, atmos_mode="lin_interp", abund_tables=mainconfig["abunds"],  pref=os.getcwd())




synthini_s = [synthV_core1, synthV_core2, synthV_core3, synthV_core4, synthV_core5, synthV_core6, synthV_core7, synthV_core8, synthV_core9, synthV_core10, synthV_core11, synthV_core12, synthV_core13, synthV_core14, synthV_core15]
synthini_simu = [synthV_imu_core1, synthV_imu_core2, synthV_imu_core3, synthV_imu_core4, synthV_imu_core5, synthV_imu_core6, synthV_imu_core7, synthV_core8, synthV_imu_core9, synthV_imu_core10, synthV_imu_core11, synthV_imu_core12, synthV_imu_core13, synthV_imu_core14, synthV_imu_core15]
...
def integrate_passband(wavelengths, flux, ifTess = True, passband=passband):
...
def update_system(mainconfig, system, params, synthV_instance, synthV_imu_instance, ifplot_main = False, if_save_mods = False, if_sbratio_spec = True, titleprefix=f'', obj_type = 'chi2', passband=passband):
    ...
    try:
        ...
        b_prim = integrate_passband(system.primary.spectrum_calib[:,0], system.primary.spectrum_calib[:,2], passband=passband)
        ...
        for i in range(7):
            integrated_Imu.append(integrate_passband(imu[:,0], imu[:,1+i], passband=passband))
    ...
    try:
        ...
        b_sec = integrate_passband(system.secondary.spectrum_calib[:,0], system.secondary.spectrum_calib[:,2], passband=passband)
    ...
    #print(system.primary.ldc)
    #print(system.secondary.ldc)
    system.sbratio = b_sec / b_prim
    #print("sbratio: ", system.sbratio)
    system.sbratio_spec = b_sec_spec / b_prim_spec
    #print("sbratio_spec: ", system.sbratio_spec)
